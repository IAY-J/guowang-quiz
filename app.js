(function () {
  ...
  function renderEditorList() {
    ...
    var filtered = master.questions.filter(matchEditorFilter);
    ...
    filtered.forEach(function (q, i) {
      ...
      upBtn.dataset.action = 'move-question';
      upBtn.dataset.id = q.id;
      upBtn.dataset.delta = '-1';
      upBtn.textContent = '上移';
      upBtn.disabled = hasFilter || filtered.length <= 1;
      var downBtn = document.createElement('button');
      downBtn.type = 'button';
      downBtn.className = 'btn btn-secondary btn-small';
      downBtn.dataset.action = 'move-question';
      downBtn.dataset.id = q.id;
      downBtn.dataset.delta = '1';
      downBtn.textContent = '下移';
      downBtn.disabled = hasFilter || filtered.length <= 1;
